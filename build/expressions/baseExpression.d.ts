...
export declare type ComputeContext = Record<string, any>;
...
export declare abstract class Expression implements Instance<ExpressionValue, ExpressionJS> {
    ...
    compute(context?: Datum, options?: ComputeOptions, computeContext?: ComputeContext): Promise<PlywoodValue>;
    computeStream(context: Datum, options: ComputeOptions, computeContext: ComputeContext): ReadableStream;
